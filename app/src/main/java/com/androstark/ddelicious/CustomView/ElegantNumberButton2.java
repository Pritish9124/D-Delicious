package com.androstark.ddelicious.CustomView;
 ...
 */
public class ElegantNumberButton2 extends RelativeLayout {
    ...
    public ElegantNumberButton2(Context context) {
        super(context);
        this.context = context;
        initView();
    }

    public ElegantNumberButton2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        initView();
    ...
    public ElegantNumberButton2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnValueChangeListener {
        void onValueChange(ElegantNumberButton2 view, int oldValue, int newValue);
    }
